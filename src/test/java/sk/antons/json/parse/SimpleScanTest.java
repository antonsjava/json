...
public class SimpleScanTest {
	...
	public void nullTest() throws Exception {
        ...
        JsonScanner scanner = JsonScanner.instance(json);
        JsonScanner.Token token = scanner.next();
        Assert.assertEquals("first: " + token, JsonScanner.Token.LITERAL_NULL, token);
	...
	public void jsonBoolTest() throws Exception {
        ...
        JsonScanner scanner = JsonScanner.instance(json);
        JsonScanner.Token token = scanner.next();
        Assert.assertEquals("first: " + token, JsonScanner.Token.LITERAL_BOOL, token);
	...
	public void scan() throws Exception {
        ...
        token = scanner.next();
        Assert.assertEquals("first: " + token, JsonScanner.Token.LITERAL_TEXT, token);
