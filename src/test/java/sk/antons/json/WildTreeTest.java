...
import sk.antons.json.match.wild.WildPathMatcher;

/**
 *
 * @author antons
 */
public class WildTreeTest {
	private static Logger log = Logger.getLogger(WildTreeTest.class.getName());
...
"}}").asObject();
	...
	public void objectTest(JsonObject o) throws Exception {
        ...
        v = o.findFirst(WildPathMatcher.instance("menu", "popup", "menuitem", "*", "value"));
        list = o.findAll(WildPathMatcher.instance("menu", "popup", "menuitem", "*", "value"));
        ...
        v = o.findFirst(WildPathMatcher.instance("menu", "popup", "**", "value"));
        list = o.findAll(WildPathMatcher.instance("menu", "popup", "**", "value"));
        System.out.println("vvv " + v.toCompactString());
        System.out.println("lll " + list);
        ...
        v = o.findFirst(WildPathMatcher.instance( "**", "value"));
        list = o.findAll(WildPathMatcher.instance( "**", "value"));
        System.out.println("vvv " + v.toCompactString());
        System.out.println("lll " + list);
        ...
        Assert.assertFalse("all menu", list.isEmpty());
        Assert.assertTrue("list contains menu", list.contains(v));
        Assert.assertEquals("value New", "File", v.asStringLiteral().stringValue());
